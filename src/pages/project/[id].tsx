      ...
      >
        ...
        >
          <motion.h1
            ...
            className="font-secondary text-4xl uppercase tracking-[10px] text-light"
          >
            {project?.title}
          </motion.h1>
          <motion.p
            ...
            className="font-secondary text-xl uppercase tracking-[10px] text-light"
          >
            {project?.description}
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="absolute bottom-4 right-4 flex h-16 flex-row-reverse space-x-4"
        >
          {projects
        ...
        <BackButton callback={() => router.push(ROUTES.PROJECTS)} />
      </motion.div>
